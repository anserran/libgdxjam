...
public class LevelLoader {
    ...
    public LevelData load(String levelName) {
        return json.fromJson(LevelData.class, Gdx.files.internal(levelName + ".json"));
    }
    ...
    public class EntityDataLoader extends ReadOnlySerializer<EntityData> {
        ...
        private Array<String> position = new Array<String>(new String[]{"wall", "astronaut"});
        private Array<String> rectangle = new Array<String>(new String[]{"wall"});
        private Array<String> circle = new Array<String>(new String[]{});
        private Array<String> rotation = new Array<String>(new String[]{"astronaut"});
        ...
        public EntityData read(Json json, JsonValue jsonData, Class clazz) {
            ...
            if (jsonData.has("type")) {
                ...
                if (rectangle.contains(type, false)) {
                    ...
                    collider.setSize(jsonData.getFloat("w"), jsonData.getFloat("h"));
                }
        ...
        private <T extends Component> T newComponent(Class<T> clazz, Array<Component> components) {
