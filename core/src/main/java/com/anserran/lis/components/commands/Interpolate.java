...
public class Interpolate implements Component, Poolable {
    ...
    public void set(Class<? extends Component> component, float x, float time, Interpolation interpolation) {
        set(component, x, 0, time, interpolation);
    }

    public void set(Class<? extends Component> component, float x, float y, float time, Interpolation interpolation) {
